 ...
 *
 *  Example of a full display GUI for displaying 4 days of CO2 values with BlueDisplay Chart.
 *  The app's menu is called by swiping horizontal from the left edge of the screen.
 *
