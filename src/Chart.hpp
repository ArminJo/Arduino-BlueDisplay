...
// mXLabelAndGridStartValueOffset is float, so we do not have a overflow here
    ...
    Serial.print(mXLabelBaseIncrementValue.TimeValue);
    Serial.print(F(")="));
    Serial.print(reduceLongWithXLabelScaleFactor(mXLabelBaseIncrementValue.TimeValue));
    Serial.print(F(" time increment="));
    Serial.print(mXLabelDistance * reduceLongWithXLabelScaleFactor(mXLabelBaseIncrementValue.TimeValue));
