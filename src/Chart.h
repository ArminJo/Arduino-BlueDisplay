...
public:
    ...
    long_float_union getYLabelStartValue(void) const;
     ...
     *  X axis
     */
    time_float_union mXLabelStartValue;
     ...
     */
    time_float_union mXLabelBaseIncrementValue; // The base increment value for one grid
...
#define CHART_X_AXIS_SCALE_FACTOR_COMPRESSION_4    -4 // compression by factor 4
     ...
     * Y axis
     */
    long_float_union mYLabelStartValue;
    long_float_union mYLabelStartOffset;
    long_float_union mYLabelIncrementValue; // Value difference between 2 grid labels - serves as Y scale factor
